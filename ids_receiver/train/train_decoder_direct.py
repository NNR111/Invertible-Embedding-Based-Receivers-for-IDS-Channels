...
def main():
    ...
    ap.add_argument('--train_samples', type=int, default=120000)
    ap.add_argument('--val_samples', type=int, default=12000)
    ...
    train_ds = SyntheticIDSDataset(
        args.train_samples,
        args.p_ins,
        args.p_del,
        args.p_sub_train_min,
        args.p_sub_train_max,
    ...
    model.encoder.load_state_dict(eckpt['encoder_state'], strict=True)

    if 'local_head_state' in eckpt:
        model.local_head.load_state_dict(eckpt['local_head_state'], strict=True)
