...
from ids_receiver.receivers.bcjr_soft_viterbi_receiver import decode_one_bcjr_softviterbi, MSG_LEN
...
def main():
    ...
    for i, p_sub in enumerate(parse_p_sub_list(args.p_sub_list)):
        ...
        print(f"p_ins={args.p_ins:.4f} p_del={args.p_del:.4f} p_sub={p_sub:.4f} BER={BER:.6f} FER={FER:.6f}")
    ...
    with open(args.out_csv, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(f, fieldnames=["p_ins", "p_del", "p_sub", "BER", "FER"])
        writer.writeheader()
